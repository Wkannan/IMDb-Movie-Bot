...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        buttons = [
            [
                InlineKeyboardButton('🤖 Updates 🤖', url='https://t.me/wottm')
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('🎗️ Updates', url='https://t.me/wottm'),
            InlineKeyboardButton('Movie Club 🎬', url='https://t.me/wottm')
            ],[
    ...
    buttons = [
        [
            InlineKeyboardButton('🎗️ Support', url='https://t.me/WK_Ak'),
            InlineKeyboardButton('Channel 🙏', url='https://t.me/WK_Ak')
        ],
        [
